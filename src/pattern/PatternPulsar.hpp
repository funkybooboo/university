...
/**
 * @brief Represents the Pulsar pattern in the Game of Life.
 *
 * This class defines the Pulsar pattern and provides methods
...
class PatternPulsar final : public Pattern
{
  public:
     ...
     *
     * Initializes the Pulsar pattern grid.
     */
    PatternPulsar();
  ...
  private:
    std::uint8_t m_sizeX;                  ///< The width of the Pulsar pattern.
    std::uint8_t m_sizeY;                  ///< The height of the Pulsar pattern.
    std::vector<std::vector<bool>> m_grid; ///< The grid representing the Pulsar pattern.
};
