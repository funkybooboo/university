...
object ShipmentFactoryManager {
    private val shipmentTypeToShipmentConstructor:  Map<String, (String, String, MutableList<String>, MutableList<ShippingUpdate>, MutableList<Long>, MutableList<String>, MutableList<String>) -> Shipment> = mapOf(
